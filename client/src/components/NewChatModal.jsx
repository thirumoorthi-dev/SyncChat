...
export default function NewChatModal({ onClose, onSelectUser, onCreateGroup }) {
          ...
          {tab === 'group' && selectedUsers.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {selectedUsers.map(u => (
                ...
                >
                  <Avatar name={u.username} color={u.avatar_color} size="xs" />
                  {u.username}
                  <button
            ...
            {loading ? (
              ...
              users.map(user => {
                ...
                return (
                  ...
                  >
                    <Avatar name={user.username} color={user.avatar_color} size="sm" isOnline={user.is_online} />
